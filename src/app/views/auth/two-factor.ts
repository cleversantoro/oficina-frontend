...
@Component({
  ...
  imports: [AuthLogo, NgOtpInputComponent, RouterLink],
  template: `
            ...
            <div class="card">
              <div class="card-body">
                <div class="auth-brand text-center mb-4">
                  <app-auth-logo />
                  <h4 class="fw-bold mt-3">Two-Factor Verification ! | HMR+</h4>
                  <p class="text-muted w-lg-75 mx-auto">We've emailed you a 6-digit verification code we sent to</p>
                </div>
